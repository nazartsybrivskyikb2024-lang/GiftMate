...
# Google Gemini API key для AI помічника
# Отримайте ключ на https://aistudio.google.com/app/apikey
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY', 'AIzaSyBHRQhAEyywkCnaV2ZD23vSMWLsIw_9byk')
